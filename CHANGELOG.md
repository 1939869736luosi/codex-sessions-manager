...
- Restricted failed-candidate recovery to a verified exact-version `ETARGET` in the original job log; unknown compare failures and hash mismatches remain release blockers.
